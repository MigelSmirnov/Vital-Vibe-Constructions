...
Status: Site knowledge entity added
...
2. Add `Project` and `Media` knowledge entities.
3. Add repository validation for cross-record references.
4. Add project/media content tables when source records are ready.

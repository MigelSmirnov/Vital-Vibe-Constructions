...
| На проверке | Солнечный коллектор: статья + анимация v3 | Приложенная владельцем ревизия v3 заменила упрощённую схему; встроена на ES / EN / RU, добавлены два фото, полный check зелёный. |
...
| Отдельный этап | VPS cutover | Не запрошен; production/DNS не менять без отдельного решения владельца. |

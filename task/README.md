...
| В процессе — блокер DNS | [003 — VPS cutover](003-vps-cutover.md) | Свежий fb31a282 собран и проверен через Caddy на VPS loopback; 69 browser checks. Для публичного переключения нужны доступ DonDominio и завершение TLS/security подготовки. Production/DNS сохранены. См. architecture/vps-cutover-20260913/report.md. |

...
| На проверке | Солнечный коллектор: статья + анимация | Перенесено хирургически в текущую архитектуру на ES / EN / RU; добавлены два фото владельца и интерактивная схема, полный check зелёный. |
